class MessageBuilder
  ...
  def bark_about_old_pull_requests
    ...
    informative_bark = "There are also these pull requests that need to be reviewed and merged today:\n\n#{list_recent_pull_requests.join} " if !recent_pull_requests.empty?
  ...
  def list_pull_requests
    ...
    "Hello team! \n\n Here are the pull requests that need to be reviewed and merged today:\n\n#{message.join}\nMerry reviewing!"
  end
